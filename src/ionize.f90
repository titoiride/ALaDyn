 ...
 real(dp) :: lstar,dge,d2ge,de_inv,deb_inv
 ...
 case(1)                  !Only ADK (no BSI)
  do k=z0+1,zm            !V(z0+1) to ionize A(z0)=> A(z0+1),
   !   V(zm) to ionize A(zm-1)> A(zm)
   j=k-z0
   ns=2.*nstar(k,ic)-1.
   do i=1,N_ge
