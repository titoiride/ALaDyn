 ...
 do n=1,np
  ...
  call qlh_3d_spline(xp1,ax1,axh,ay1,ayh,az1,azh,i,ih,j,jh,k,kh)
...
!=======================================
 ...
 case(3)
  ...
  do n=1,np
   ...
   call qqh_3d_spline(xp1,ax1,axh,ay1,ayh,az1,azh,i,ih,j,jh,k,kh)
...
!===========================
 ...
 axh1(0:2)=zero_dp;ayh1(0:2)=zero_dp
  k2=1
  do n=1,np
   pt(n,1:2)=sp_loc%part(n,1:2)
  end do
...
!=============================
 case(3)
  ax1(0:2)=zero_dp;ay1(0:2)=zero_dp
  az1(0:2)=zero_dp;azh1(0:2)=zero_dp
  axh1(0:2)=zero_dp;ayh1(0:2)=zero_dp
  do n=1,np
   pt(n,1:3)=sp_loc%part(n,1:3)
  end do
  ...
  do n=1,np
   ...
   call qqh_3d_spline(xp1,ax1,axh1,ay1,ayh1,az1,azh1,i,ih,j,jh,k,kh)
...
!===============Jx ========
 ...
 do n=1,np
  ...
  call qlh_3d_spline(xp0,ax0,axh0,ay0,ayh0,az0,azh0,i0,ih0,j0,jh0,k0,kh0)
!====================
  call qlh_3d_spline(xp1,ax1,axh1,ay1,ayh1,az1,azh1,i,ih,j,jh,k,kh)
!======================   Jx
   do k1=0,2
    k2=k+k1
    do j1=0,2
