...
!=============================
 ...
 if(pe0)then
  write(6,*)"    _    _          ____              ____    ___ "
  write(6,*)"   / \  | |    __ _|  _ \ _   _ _ __ |___ \  / _ \ "
  write(6,*)"  / _ \ | |   / _` | | | | | | | '_ \  __) || | | |"
  write(6,*)" / ___ \| |__| (_| | |_| | |_| | | | |/ __/ | |_| |"
  write(6,*)"/_/   \_|_____\__,_|____/ \__, |_| |_|_____(_\___/ "
  write(6,*)"                          |___/                    "
 endif                                                                             
 if(pe0)then
  write(6,*)'==================================================='
  write(6,'(a32,i1,a1,i2,a16)') ' =              Code version    ',major_version,'.'&
  &,minor_version,'               ='
  write(6,*)'==================================================='
