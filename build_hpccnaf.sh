...
#mkdir build_ifort ; cd build_ifort ; cmake .. -DMKL_ROOT=/shared/software/compilers/intel_2017/mkl -DBoost_NO_BOOST_CMAKE=ON -DCMAKE_C_COMPILER=/shared/software/compilers/intel_2017/compilers_and_libraries_2017.0.098/linux/bin/intel64/icc -DCMAKE_CXX_COMPILER=/shared/software/compilers/intel_2017/compilers_and_libraries_2017.0.098/linux/bin/intel64/icc -DCMAKE_Fortran_COMPILER=/shared/software/compilers/intel_2017/compilers_and_libraries_2017.0.098/linux/bin/intel64/ifort ; cmake --build . --target install ; cd ..
